...
4.1.3. Remove any electronic addresses (Ex. Electronic address: easloffice@easloffice.eu).

4.1.4. Check that all :ref:`mononyms<mononym>` (names which have no initials) are “true” mononyms (check `PubMed <https://pubmed.ncbi.nlm.nih.gov/>`_ site).
